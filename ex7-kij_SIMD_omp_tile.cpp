...
#include <omp.h>		// visual studio C/C++ -> language -> open MP support : /openmp
int num_threads = 8;
...
void main() {
	...
	num_threads = 1;	test(mat_mul_kij);
	num_threads = 8;	test(mat_mul_kij);
	puts("");
	num_threads = 1;	test(mat_mul_kij_avx);
	num_threads = 8;	test(mat_mul_kij_avx);
	puts("");
	num_threads = 1;	test(mat_mul_kij_avx2);
	num_threads = 8;	test(mat_mul_kij_avx2);
	puts("");
	num_threads = 1;	test(mat_mul_kij_avx8);
	num_threads = 8;	test(mat_mul_kij_avx8);
	puts("");
	//num_threads = 1;	test(mat_mul_tile_kij_avx8);
	//num_threads = 8;	test(mat_mul_tile_kij_avx8);
